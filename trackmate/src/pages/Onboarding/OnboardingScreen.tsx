...
const onboardingData: OnboardingData[] = [
  {
    ...
    description: "Whether it's a quick wander or the full 1000km trek, TrackMate keeps you on track, shares the stories of the land, and helps you enjoy every step of the journey.",
    icon: footsteps,
  ...
  },
  {
    ...
    description: "Scan the codes along the trail for local stories, safety tips, and nearby facilities, right when you need them.",
    icon: qrCode,
  ...
  },
  {
    ...
    description: "If you come across a fallen tree, damaged sign, or hazard, snap a photo and send a quick report — even offline. Your feedback helps keep the track clear and safe for everyone.",
    icon: warning,
  ...
  },
  {
    ...
    description: "Your feedback helps us understand how visitors experience the Track and supports future improvements to design, management, and funding.",
    icon: chatbubbles,
