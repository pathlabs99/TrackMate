...
// Generate report ID function - without randomness
...
// Create clean HTML content for emails
const createCleanHTMLContent = (reportData, coordinates = null) => {
...
app.post('/send-report', async (req, res) => {
  ...
  try {
    ...
    if (req.body.csvData && req.body.fileName) {
      ...
      // Create HTML content
      const htmlContent = createCleanHTMLContent(reportData, coordinates);
...
`;
      ...
      // Add JSON attachment of the full report data
      /*
      mailOptions.attachments.push({
        filename: `${reportId}_issue_report.json`,
...
// Helper function to create HTML content for survey email
